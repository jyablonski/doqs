...
description: Runbook for recreating AWS infrastructure when rotating to a new account.
lastUpdated: 2026-05-13
author: jyablonski
tags: ["runbook", "aws", "terraform", "infrastructure"]
---
...
:::caution[Pending]
This runbook may not be needed in the future because the AWS Free Tier [changed significantly](https://aws.amazon.com/about-aws/whats-new/2025/07/aws-free-tier-credits-month-free-plan/) in July 2025.
:::
...
5. Create a new AWS Account with a new email
6. Add Root MFA onto new AWS Account
7. Go to `Account` and enable IAM Policy for Billing Access
...
15. Go to [Squarespace](https://account.squarespace.com/domains/managed/jyablonski.dev/dns/domain-nameservers), open DNS -> Domain Nameservers, and update them based on the `NS` values in the Route 53 Hosted Zone
    - <Image
        src={route_53}
...
20. Run all CI / CD Pipelines to build and push the Docker images for each service to ECR
